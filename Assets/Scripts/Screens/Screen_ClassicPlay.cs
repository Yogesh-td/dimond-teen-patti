...
{
    public class Screen_ClassicPlay : Base_Screen
    {
        [Space]
        ...
        {
            List<ITABLESETTINGS> tables = AppManager.Instance.GameTables;
            ...
            selected_table = AppManager.Instance.GameTables[0];
            base.Show();
        ...
        private void Instance_Event_Room_Updated(GAME_TYPE game_type, string table_id)
        {
            ...
            txt_online_players.text = "" + (int)ColyseusRoomManager.Instance.Get_Total_Metadata(GAME_TYPE.CLASSIC, selected_table._id).Sum(x => { return x.metadata.current_users; });
        }
        ...
        private void OnChanged_Slider(float index)
        {
            ...
            selected_table = AppManager.Instance.GameTables[(int)index];
        ...
        private void OnClick_Join()
        {
            ...
            TPRoomManager.Instance.JoinRoom(GAME_TYPE.CLASSIC, selected_table._id,
                () =>
                {
